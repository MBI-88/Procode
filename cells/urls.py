...
urlpatterns = [ 
    ...
    path('shoping/<slug:slug>/',views.DetailItem.as_view(),name='dashboar_detail'),
    path('create/item/',views.CreateItem.as_view(),name='create_item'),
    path('update/item/<slug:slug>/',views.UpdateItem.as_view(),name='update_item'),
    path('delete/item/<slug:slug>/',views.DeleteItem.as_view(),name='delete_item'),
    path('profile/',views.ProfileUser.as_view(),name='profile'),
    path('update/profile/<slug:slug>',views.UpdateProfile.as_view(),name='update_profile'),
    path('delete/profile/<slug:slug>/',views.DeleteProfileUser.as_view(),name='delete_profile'),
]